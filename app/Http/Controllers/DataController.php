...
class DataController extends Controller
{
    ...
    public function createpdf(){
        ...
        // $img = Image::make($base64Png);

        // // Create a new canvas with a white background of the same size as the original image
        // $canvas = Image::canvas($img->width(), $img->height(), '#FFFFFF');
        
        // // Insert the original image onto the white canvas
        // $canvas->insert($img, 'center');
        
        // // Encode the canvas as a base64-encoded JPEG with a specified quality (e.g., 90)
        // $base64Jpeg = $canvas->encode('data-url', 90, 'jpg');
        ...
        // $filePath = public_path('/assets/images/my_image.jpg'); // Change the path and filename as needed
       ...
       // return view('pdf',compact('podpis','imie_nazwisko','ulicanr','miasto','kodpocztowy','date','model','suma'));
        view()->share('pdf',$data);
        $pdf = PDF::loadView('pdf',$data);
        // download PDF file with download method
